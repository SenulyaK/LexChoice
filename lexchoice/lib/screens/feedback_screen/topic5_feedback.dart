...
class DetailedFeedbackScreenTopic5 extends StatefulWidget {
  const DetailedFeedbackScreenTopic5({super.key});
...
class _DetailedFeedbackScreenTopic1State
    extends State<DetailedFeedbackScreenTopic5> {
  late Future<int> score;

  // Fetch score from the API based on gameID
  Future<int> fetchScore() async {
    final response = await http.get(Uri.parse(
        'http://localhost:8080/api/v1/score/get-score?game_id=5&user_id=1'));
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildPerformanceItem(
                        icon: Icons.people,
                        title: "Cyber Security Mesusures",
                        correct: true,
                        iconColor: LCColors.success,
                      ),
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        AmyGameScreen()), // Navigate to the screen
