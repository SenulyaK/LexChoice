...
class DetailedFeedbackScreenTopic4 extends StatefulWidget {
...
class _DetailedFeedbackScreenTopic1State
    extends State<DetailedFeedbackScreenTopic4> {
  late Future<int> score;

  // Fetch score from the API based on gameID
  Future<int> fetchScore() async {
    final response = await http.get(Uri.parse(
        'http://localhost:8080/api/v1/score/get-score?game_id=4&user_id=1'));
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        DevinGameScreen()), // Navigate to the screen
