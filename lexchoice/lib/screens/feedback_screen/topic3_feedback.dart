...
class DetailedFeedbackScreenTopic3 extends StatefulWidget {
  const DetailedFeedbackScreenTopic3({super.key});
...
class _DetailedFeedbackScreenTopic1State
    extends State<DetailedFeedbackScreenTopic3> {
  late Future<int> score;

  // Fetch score from the API based on gameID
  Future<int> fetchScore() async {
    final response = await http.get(Uri.parse(
        'http://localhost:8080/api/v1/score/get-score?game_id=3&user_id=1'));
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: LCSizes.sm), // Spacing
                                Text(
                                  "2 minutes 30 seconds", // Time taken
                                  style: GoogleFonts.poppins(
                                    fontSize: LCSizes.fontSizeMd,
                                    fontWeight: FontWeight.w500,
                                    color: textColor,
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        RaviGameScreen()), // Navigate to the screen
